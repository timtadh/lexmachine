...
func TestDesugarRanges(x *testing.T) {
	...
	t.Log(ast.String())
	parsed := "(Match (Concat (? (Concat (* (Concat (+ (Range 97 122)), (Range 65 90))), (Range 48 57))), (Character w), (Character i), (Character z), (Character a), (Character r), (Character d)))"
